# 📱 Aplicativo Android WebView — WS Segurança Residencial
...
## ✨ Recursos Inclusos:
- 🚀 **Navegação Rápida**: Carrega o site da WS Segurança com aceleração de hardware e DOM Storage ativado.
...
- 🎨 **Tema Dark Moderno**: Barra de status integrada com o layout da WS Segurança.
